...
const CommentModel = () => {
    ...
    <div>
        ...
        {open && (
            ...
            >
                {/** the main div of the modal */}
                <div className='p-1'> 
                    
                     {/** header modal */}
                    <div className='border-b border-gray-200 py-2 px-1.5'>
                        <div className='hoverEffect w-9 h-9 flex items-center justify-center p-2' onClick={()=>setOpen(false)}>
                            <XIcon className='h-[22px] text-color-700' />
                        </div>
                    </div>
                    ...
                    <div className='p-2 flex items-center space-x-1 relative '>
                        ...
                        <span className="text-sm sm:text-[15px] hover:underline">
                            <Moment fromNow>{post?.data()?.timestemp?.toDate()}</Moment>
                        </span>
                    </div>
                        ...
                        <div className="flex  p-3 space-x-3">
                            ...
                            <div className="w-full divide-y divide-gray-200">
                                ...
                                <div className="flex items-center justify-between pt-2.5 ">
                                    ...
                                    <button onClick={sendComment} className="bg-blue-400 text-white px-4 py-1.5 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50" disabled={!input.trim()}>
                                        Reply
                                    </button>
                                </div>
                            </div>
