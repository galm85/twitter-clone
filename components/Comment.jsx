            ...
            <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-1 whitespace-nowrap items-center">
                        ...
                        <span className="text-sm sm:text-[15px] hover:underline"><Moment fromNow>{comment?.timestemp?.toDate()}</Moment></span>
                    </div>
                    {/* dots icon */}
                ...
                <div className="flex justify-between text-gray-500 p-2">
                    ...
                    {/* trash icon */}
                    {session?.user?.uid === comment?.userId && <TrashIcon className="w-9 h-9 hoverEffect p-2 hover:text-red-600 hover:bg-red-100" onClick={deleteComment}/> }
                    
                    {/* like icons */}
                    <div className="flex items-center">
                        {hasLiked ? ( 
                                <HeartIconFilled onClick={likeComment} className="w-9 h-9 hoverEffect p-2 text-red-600 hover:bg-red-100"/>
                                ) : (                
                                <HeartIcon onClick={likeComment} className="w-9 h-9 hoverEffect p-2 hover:text-red-600 hover:bg-red-100"/>
                                )
                        }
